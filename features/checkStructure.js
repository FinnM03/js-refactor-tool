...
const crypto = require("crypto"); // Required for hashing code blocks
...
async function runStructureCheck() {
  ...
  const analysisResults = analyseCodeStructure(ast, code, lines); // Ensure this uses checkCodeDuplication
...
function calculateHealthScore(
  ...
  const duplicationPenalty = duplicateCode.length > 0 ? 1 : 0; // Add a small penalty for duplication
